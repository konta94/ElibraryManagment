                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-3">
                                ...
                                <div class="mb-3">
                                    <div class="input-group">
                                        ...
                                        <asp:LinkButton class="btn btn-primary" ID="LinkButton4" runat="server"><i class="fas fa-times-circle"></i></asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    <asp:TextBox CssClass="form-control" ReadOnly="true" ID="TextBox1" runat="server" placeholder="Full Name"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-5">
                                ...
                                <div class="mb-3">
                                    <div class="input-group">
                                        <asp:TextBox CssClass="form-control me-1" ID="TextBox7" runat="server" ReadOnly="true" placeholder="Account Status"></asp:TextBox>
                                        <asp:LinkButton class="btn btn-success me-1" ID="LinkButton1" runat="server"><i class="fas fa-check-circle"></i></asp:LinkButton>
                                        <asp:LinkButton class="btn btn-warning me-1" ID="LinkButton2" runat="server"><i class="far fa-pause-circle"></i></asp:LinkButton>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="mb-3">
                                        <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" ReadOnly="true" placeholder="Full Postal Address" Rows="2" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                            </div>
                            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-8 text-center">
                                <asp:Button class="btn btn-danger btn-lg" ID="Button2" runat="server" Text="Delete User Permanently" />
                            </div>
                        </div>
